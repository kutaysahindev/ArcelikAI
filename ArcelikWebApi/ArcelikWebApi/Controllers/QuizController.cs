        ...
        public async Task<ActionResult> SubmitQuiz([FromBody] List<UserResponseDTO> userResponses)
        {
            try
            {
                ...
                foreach (var response in userResponses)
                {
                    ...
                    {
                        case "Sorting": // DragAndSort Question Type
                                        // Find the correct sorting order for the given question ID

                            if (response.ReceivedSortingOrder == null)
                            {
                                break;
                            }
                        ...
                        case "FillInTheBlank":
                            ...
                            if (response.ReceivedTextAnswer == null)
                            {
                                break;
                            }
                        ...
                        default:
                            return BadRequest($"Unsupported question type: {response.ReceivedQuestionType}");
                ...
                //check if the user is passed or not
